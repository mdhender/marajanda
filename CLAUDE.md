...
- [docs/reference/](docs/reference/) — `player-origin.md`, `terrain.md`, `compass.md`, `map-view.md`, `entities.md`, `orders.md`, `action-points.md`, `knowledge.md`, `glossary.md`.
- [docs/explanation/](docs/explanation/) — `world-size.md`.
