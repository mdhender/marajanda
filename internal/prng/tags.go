...
// of all draws for a hex. TagPlayer and TagFaction draws use their game-assigned
// numbers, which must likewise be stable — never database row ids.
//
...
const (
	...
	TagPlayer               // 2: per-player draws, addressed by player number
